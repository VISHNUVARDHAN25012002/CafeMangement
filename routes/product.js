...
router.post('/addProd',auth.authenticationToken,checkRole.checkRole,(req,res)=>{
...
router.get('/getProd',auth.authenticationToken,(req,res,next)=>{
...
router.patch('/updateProd', auth.authenticationToken, checkRole.checkRole, (req, res, next) => {
    let product = req.body;
